...
namespace Quilter.Widgets {
    public class Preview : WebKit.WebView {
        ...
        private string set_font_stylesheet () {
            ...
            if (gsettings.get_string("preview-font") == "serif") {
                return Build.PKGDATADIR + "/font/serif.css";
            } else if (gsettings.get_string("preview-font") == "sans") {
                return Build.PKGDATADIR + "/font/sans.css";
            } else if (gsettings.get_string("preview-font") == "mono") {
        ...
        private string set_highlight () {
            ...
            if (gsettings.get_boolean("highlight")) {
        ...
        private string set_latex () {
            ...
            if (gsettings.get_boolean("latex")) {
